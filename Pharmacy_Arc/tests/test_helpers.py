...
class TestRequireAuth:
    def _make_app(self):
        app = Flask(__name__)
        app.secret_key = "test-secret-key-that-is-32-chars!"  # noqa: S105 — test fixture
        return app
...
class TestValidateAuditEntry:
    def test_valid_entry(self):
        ...
        data = {"date": "2026-02-20", "reg": "Reg 1", "staff": "John", "gross": 100.0, "net": 90.0, "variance": -5.0}
    ...
    def test_invalid_date_format(self):
        ...
        data = {"date": "02/20/2026", "reg": "Reg 1", "staff": "John", "gross": 100.0, "net": 90.0, "variance": -5.0}
        ok, msg = validate_audit_entry(data)
        assert ok is False
        assert "date" in msg.lower()
    ...
    def test_negative_gross_rejected(self):
        ...
        data = {"date": "2026-02-20", "reg": "Reg 1", "staff": "John", "gross": -1.0, "net": 90.0, "variance": -5.0}
        ok, msg = validate_audit_entry(data)
        assert ok is False
...
class TestValidateUserData:
    def test_valid_new_user(self):
        ...
        data = {"username": "newuser", "password": "password123", "role": "staff", "store": "Carimas #1"}
    ...
    def test_short_username_rejected(self):
        ...
        data = {"username": "ab", "password": "password123", "role": "staff", "store": "Carimas #1"}
        ok, msg = validate_user_data(data, is_update=False)
        assert ok is False
    ...
    def test_short_password_rejected(self):
        ...
        data = {"username": "newuser", "password": "short", "role": "staff", "store": "Carimas #1"}
        ok, msg = validate_user_data(data, is_update=False)
        assert ok is False
    ...
    def test_invalid_role_rejected(self):
        ...
        data = {"username": "newuser", "password": "password123", "role": "superuser", "store": "Carimas #1"}
        ok, msg = validate_user_data(data, is_update=False)
        assert ok is False

...
PHARMACY_CONTEXT = (
    ...
    "Stores:\n"
    "  Carimas #1 — Ave. Boulevard EB-1 Esq. Gautier Benitez, Levittown, Toa Baja, PR 00949 — Tel: (787) 784-5265 — Hours: M-S 8AM-9PM, Sun 9AM-5PM\n"
    "  Carimas #2 — Carretera 152 Km 8.0, Barrio Quebradillas, Barranquitas, PR 00794 — Tel: (787) 857-8800 — Hours: M-S 8AM-9PM, Sun 9AM-5PM\n"
    "  Carimas #3 — 2021 Sabana Seca, Toa Baja, PR 00949 — Tel: (787) 261-9191 — Hours: M-S 8AM-9PM, Sun 9AM-5PM\n"
    "  Carimas #4 — 65 C. San Patricio, Loiza, PR 00772 — Tel: (787) 256-0404 — Hours: M-S 8AM-9PM, Sun 9AM-5PM\n"
    "  Carthage Express — 201b C. de San Justo, San Juan, PR 00901 — Tel: (787) 487-2720 — Hours: M-S 8AM-9PM, Sun 9AM-5PM\n\n"
    "Procedures:\n"
    ...
    "Contacts:\n"
    "  - Tech support: Mutasim Yassin — (787) 961-9090\n"
    "  - General management (C1, C4): Khalid Yassin\n"
    "  - General management (C2, C3, Carthage): Mutasim Yassin\n\n"
